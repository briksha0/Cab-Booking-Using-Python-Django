! function(e) {
    ...
    if (e(window).on("load", (function() {
        ...
        }, e(".th-menu-wrapper").vsmobilemenu(), e(window).on("scroll", (function() {
            var t = e(this).scrollTop();

            function a() {
                t > 400 && (e(".sticky-wrapper").addClass("sticky"), e(".sticky-wrapper").removeClass("will-sticky"))
            }
            a(), t > 150 ? (e(".sticky-wrapper").addClass("will-sticky"), a()) : (e(".sticky-wrapper").removeClass("sticky"), e(".sticky-wrapper").removeClass("will-sticky"))
    ...
    var o, i, r, l = ".ajax-contact",
        c = "is-invalid",
        d = '[name="email"]',
        u = '[name="name"],[name="email"],[name="subject"],[name="message"]',
        p = e(".form-messages");
    ...
    function f() {
        ...
        }(u), e(d).val() && e(d).val().match(/^([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?$/) ? (e(d).removeClass(c), a = !0) : (e(d).addClass(c), a = !1), a
    }
    if (e(l).on("submit", (function(e) {
            e.preventDefault(), h()
        })), e(".ajax-booking").length > 0) {
        l = ".ajax-booking", d = '[name="email"]', c = "is-invalid", u = '[name="name"],[name="number"],[name="email"],[name="s-destination"],[name="e-destination"],[name="passenger"],[name="date"],[name="time"],[name="vehicle"],[name="message"]', p = e(".form-messages");
    ...
    o = ".popup-search-box", i = ".searchClose", r = "show", e(".searchBoxToggler").on("click", (function(t) {
        ...
        format: "H:i",
        step: 30
    }), (new WOW).init(), e(".counter-number").counterUp({
        delay: 10,
        time: 1e3
        ...
        e(this).each((function() {
            ...
            s = Math.floor(l.height() / 2), n = l.attr(t), o = l.attr(a), i = g(e(o).css("padding-top")), r = g(e(o).css("padding-bottom")), "top-half" === n ? (e(o).css("padding-bottom", r + s + "px"), l.css("margin-top", "-" + s + "px")) : "bottom-half" === n && (e(o).css("padding-top", i + s + "px"), l.css("margin-bottom", "-" + s + "px"))
        }))
    };
